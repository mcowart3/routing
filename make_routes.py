...
def make_routes(dists, times, caps, deliveries, truckcapacity, numtrucks, reals, nodeList, truck, day):
    ...
    while True:
        ...
        for j in nodeList:
            ...
            if not j.visit:
                ...
                #avoid if nothing to deliver or pickup
                if newcap == 0 and newdel == 0:
                    continue
                ...
                if newdel > 0:
                    ...
                    #max instead of sum here b/c we can offload deliveries before loading pickups   
        ...
        if newday:
            ...
            nextDay(truck, loc, sumUnits, deliv)
        ...
        if target == 0:
            ...
            #no break; continue building route
